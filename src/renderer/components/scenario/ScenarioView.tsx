...
const MATRIX_TAB_ORDER: PlatformId[] = ['video', 'douyin', 'xhs', 'kuaishou', 'bilibili', 'shipinhao', 'toutiao', 'x', 'binance', 'okx', 'bitget', 'bybit', 'gate', 'youtube', 'tiktok', 'facebook', 'reddit', 'instagram'];
