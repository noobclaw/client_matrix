...
const MATRIX_TAB_ORDER: PlatformId[] = ['video', 'douyin', 'xhs', 'kuaishou', 'bilibili', 'shipinhao', 'toutiao', 'x', 'binance', 'bitget', 'bybit', 'gate', 'youtube', 'tiktok', 'facebook', 'reddit', 'instagram'];
