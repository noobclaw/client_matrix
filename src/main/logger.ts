 ...
 *
 * Log file locations:
 *   macOS:   ~/Library/Logs/NoobClaw/main.log
 *   Windows: %USERPROFILE%\AppData\Roaming\NoobClaw\logs\main.log
 *   Linux:   ~/.config/NoobClaw/logs/main.log
 */
...
export function initLogger(): void {
  ...
  // Log startup marker
  log.info('='.repeat(60));
  log.info(`NoobClaw started (${process.platform} ${process.arch})`);
  log.info('='.repeat(60));
}
