...
name_zh: "本地工具"
description_zh: "本地系统工具集：文件管理、系统信息等"
official: true
---
...
# "Calendar access permission is required. Please open System Settings > Privacy & Security > Calendar, and authorize Terminal or NoobClaw"
```
...
```
**Solution:** Open System Settings > Privacy & Security > Calendar, authorize Terminal or NoobClaw
