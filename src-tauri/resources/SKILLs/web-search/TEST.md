...
This guide walks through testing the entire Web Search Skill integration with NoobClaw.

## Prerequisites

1. NoobClaw built and ready to run
2. Google Chrome installed
3. Internet connection available

## Test 1: Service Auto-Start

**Objective:** Verify that the Bridge Server starts automatically with NoobClaw.

**Steps:**

1. Start NoobClaw in development mode:
   ```bash
...
**Expected Result:** ✅ Bridge Server starts automatically within 3 seconds of NoobClaw launch.
...
1. Open a terminal while NoobClaw is running
...
**Objective:** Verify graceful shutdown of services when NoobClaw quits.

**Steps:**

1. With NoobClaw running and searches completed, quit the application
...
1. Start NoobClaw (ensure headless is false in config)
...
- ✅ Server auto-starts with NoobClaw
